...
**历史结果，已不适用于当前版本。** 2026-09-09 重新验证：`gen_01001000`、
开启宏观守方、前两波，种子 1 为 4,990 tick，种子 2 为 4,781 tick，
招兵与最终守方编成也不同。当前守方拉扯和攻方侦查存在按种子驱动的随机行为；
固定种子仍可复现，但不同种子不等于重复同一局。下文保留旧实验背景，
“只换地图即可”的旧建议不要用于当前 RL 对照。
